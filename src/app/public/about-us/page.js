 ...
 * It loads page data and displays the AboutUsSection component.
 * File-based routing: /about-us → app/public/about-us/page.js
 */
class AboutUsPage extends App {
    connectedCallback() {
        super.connectedCallback();
        document.title = 'About Us | Church System';
        this.loadAllData();
    }
    ...
    async loadAllData() {
        try {
            ...
            // Load page data for about-us
            const pageResponse = await api.get('/pages/about-us');
            ...
            console.error('Error loading about us page data:', error);
...
customElements.define('about-us-page', AboutUsPage);
