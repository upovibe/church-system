...
class NewsPage extends App {
    ...
    getHeaderCounts() {
        ...
        news.forEach((item) => {
            ...
            if (item.image) withImages += 1;
            if (Number(item.is_featured) === 1) featured += 1;
        });
                ...
                <div class="bg-slate-700 rounded-xl shadow-lg p-5 text-white">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6">
                        <div>
                            ...
                            <p class="text-blue-100 text-base sm:text-lg">Manage church ministries and news</p>
                        </div>
                        <div class="mt-4 sm:mt-0">
                            <div class="text-right">
                                <div class="text-xl sm:text-2xl font-bold">${c.total}</div>
                                <div class="text-blue-100 text-xs sm:text-sm">Total Ministries</div>
                            </div>
                        </div>
                    </div>
