...
class EventsPage extends App {
    ...
    getHeaderCounts() {
        ...
        events.forEach((event) => {
            const isActive = Number(event.is_active) === 1;
            if (isActive) active += 1; else inactive += 1;
            const eventDate = new Date(event.event_date);
            if (eventDate > now) upcoming += 1; else past += 1;
        });
        return { total, active, inactive, upcoming, past };
    }
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6">
                        <div>
                            <div class="flex items-center gap-2">
                                ...
                                <button 
                                    onclick="this.closest('app-events-page').loadData()"
                            ...
                            <p class="text-blue-100 text-base sm:text-lg">Manage church events and activities</p>
                        </div>
