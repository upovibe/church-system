    ...
    if (user && pageConfig.restrictRoles) {
      ...
      if (restrictedRoles.includes(user.role)) {
        ...
        if (typeof pageConfig.redirectTo === "function") {
          ...
          redirectPath =
            pageConfig.restrictRedirect ||
            pageConfig.redirectTo ||
            "/dashboard";
        }
        ...
        return {
          ...
          redirect: redirectPath,
          reason:
            pageConfig.restrictReason || "Access restricted for your role",
        };
      }
    }
...
function createTimeRestriction(
  startHour,
  endHour,
