...
class ConnectSection extends App {
    ...
    render() {
        ...
        if (pageData.banner_image) {
            try {
                const banners = typeof pageData.banner_image === 'string' ? JSON.parse(pageData.banner_image) : pageData.banner_image;
        ...
        <section class="px-5 py-4">
            <div class="container mx-auto bg-slate-800 rounded-2xl shadow-2xl p-8 py-20 backdrop-blur-sm bg-opacity-95">
