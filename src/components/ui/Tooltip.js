...
class Tooltip extends HTMLElement {
  ...
  positionTooltip() {
    ...
    switch (position) {
      case "top":
        ...
        tooltip.style.top =
          trigger.top - tooltipRect.height - margin - arrowSize + "px";
        break;
      case "top-start":
      ...
      case "left":
        tooltip.style.left =
          trigger.left - tooltipRect.width - margin - arrowSize + "px";
  ...
  updateVariant() {
    ...
    const variant = this.getAttribute("variant") || "default";
    this.tooltipElement.className = this.tooltipElement.className.replace(
      /tooltip--(default|primary|success|warning|error|info)/,
      `tooltip--${variant}`,
    );
  }
