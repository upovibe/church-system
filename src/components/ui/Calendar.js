...
class Calendar extends HTMLElement {
  constructor() {
    ...
    this.minDate = this.getAttribute("min-date")
      ? new Date(this.getAttribute("min-date"))
      : null;
    this.maxDate = this.getAttribute("max-date")
      ? new Date(this.getAttribute("max-date"))
      : null;
  ...
  renderDays() {
    ...
    const isRangeStart = (date) => {
      ...
      return (
        ...
        this.rangeStart.toISOString().split("T")[0]
      );
    };
    ...
    const isRangeEnd = (date) => {
      ...
      return (
        date.toISOString().split("T")[0] ===
        this.rangeEnd.toISOString().split("T")[0]
      );
    };
  ...
  selectRangeDate(dateString) {
    ...
    if (
      !this.rangeStart ||
      (this.rangeStart &&
        this.rangeStart.toISOString().split("T")[0] === dateString)
    ) {
