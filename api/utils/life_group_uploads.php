...
function uploadLifeGroupBanner($file) {
    ...
    if (extension_loaded('gd')) {
        $thumbnails = generateLifeGroupThumbnails($originalPath, $filename, $thumbnailsDir);
    } else {
        error_log('GD extension not available. Skipping thumbnail generation for life groups.');
    }
...
function deleteLifeGroupBanner($imagePath) {
    ...
    $thumbnailsDir = $baseDir . 'uploads/life-groups/thumbnails/';
