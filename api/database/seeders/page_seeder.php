    ...
    private function seedDefaultPages()
    {
        ...
        $defaultPages = [
            ...
            [
                ...
                'content' => '<h2>Supporting Our Ministry</h2><p>Your generous contributions help us continue our mission of spreading God\'s love and serving our community. Every gift, no matter the size, makes a difference in our ability to minister effectively.</p><h3>Ways to Give</h3><ul><li><strong>Sunday Offering:</strong> During our worship services</li><li><strong>Online Giving:</strong> Secure online donations</li><li><strong>Mail:</strong> Send checks to our church office</li><li><strong>Automatic Giving:</strong> Set up recurring donations</li></ul><h3>Where Your Gifts Go</h3><p>Your donations support our various ministries, community outreach programs, facility maintenance, and staff support.</p>',
                'meta_description' => 'Support our church ministry through generous giving. Learn about different ways to contribute to our mission.',
                'category' => 'general',
                'is_active' => 1,
                'sort_order' => 3,
                'banner_image' => json_encode(['uploads/pages/5_1752713285_687848450g'])           
